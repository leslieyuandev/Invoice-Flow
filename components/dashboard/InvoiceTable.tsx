        ...
        <tbody className="divide-y divide-surface-50">
          {invoices.map((invoice) => (
            <tr key={invoice.id} className="group hover:bg-surface-50 transition-colors">
              ...
              <td className="hidden md:table-cell py-3.5 px-4 text-surface-500">{formatDate(invoice.issueDate)}</td>
              <td className="hidden md:table-cell py-3.5 px-4 text-surface-500">{formatDate(invoice.dueDate)}</td>
